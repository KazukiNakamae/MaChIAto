...
def convert_crispresso2row_to_crispresso(crispresso2_row):
    ...
    if crispresso2_row['Reference_Name'] == "HDR":
        ...
        if crispresso2_row['Read_Status'] == "UNMODIFIED":
            ...
            error(err_msg)
            sys.exit(1)
    elif crispresso2_row['Reference_Name'] == "Prime-edited":
        ...
        if crispresso2_row['Read_Status'] == "UNMODIFIED":
            ...
            error(err_msg)
            sys.exit(1)
    elif crispresso2_row['Reference_Name'] == "Scaffold-incorporated":
...
"""
def hide_minor_class(label, value, th):
    if value > th:
        return(label)
    else:
        return("")
