  ...
  public = list(
    ...
    initialize = function(whole.region.microhomology.seq.vec = character(0),
      ...
      tryCatch({
        ...
        private$checkMode(is.left.both.microhomology.logical, "is.left.both.microhomology.logical", "logical")
        ...
        self$is.left.both.microhomology.logical = is.left.both.microhomology.logical
        ...
        self$focusing.region.seq.df <- data.frame(focusing.region.seq = self$whole.region.microhomology.seq.vec,
                                                                annotation = self$annotation.vec, stringsAsFactors = FALSE)
